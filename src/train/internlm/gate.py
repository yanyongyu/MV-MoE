...
from src.adapter.internlm import InternLM3DecoderLayerAdapter, apply_adapter
from src.dataset.cblue import get_dataset
from src.model.internlm.model import InternLM3ForCausalLM

MODEL_NAME = "./data/internlm-merged-v1"
...
args = SFTConfig(
    ...
    max_seq_length=1024,
    deepspeed="ds_config_stage_1.json",
)
...
# init gate value
for layer in cast(InternLM3ForCausalLM, model).model.layers:
    patched_layer = cast(InternLM3DecoderLayerAdapter, layer)
